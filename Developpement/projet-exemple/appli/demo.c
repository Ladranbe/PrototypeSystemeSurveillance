...
{
	{""					},		//CHOICE_NONE,
	{"LCD2x16"			},		//CHOICE_LCD2X16,
	{"SD "				},		//CHOICE_SD_CARD,
	{"USB"				},		//CHOICE_USB_KEY,
	{"Accelerometer"	},		//CHOICE_ACCELEROMETER,
	{"PWM"				},		//CHOICE_PWM,
	{"ADC"				},		//CHOICE_ADC,
	{"DAC"				},		//CHOICE_DAC,
	{"Mouse"			},		//CHOICE_MOUSE,
	...
	{"Motor with H Bridge"},	//CHOICE_MOTOR_WITH_H_BRIDGE
	{"Audio"			}		//CHOICE_AUDIO
};
...
static void DEMO_state_machine(bool_e button_pressed, char touch_pressed)
{
	...
	switch(state)
	{
		...
		case CHOICE_LCD2X16:
			...
			break;
		case CHOICE_MOTOR_WITH_H_BRIDGE:
			if(DEMO_MOTOR_statemachine(button_pressed, touch_pressed))
				state = INIT;
			break;
		case CHOICE_AUDIO:
			if(DEMO_audio_statemachine(button_pressed, touch_pressed))
				state = INIT;
