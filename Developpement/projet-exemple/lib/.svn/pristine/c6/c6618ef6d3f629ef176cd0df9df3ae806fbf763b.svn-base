...
char KEYBOARD_get_key(void)
{
	...
	for(i=0;i<4;i++)
	{
		...
		switch(i)
		{
			case 0:	GPIO_SET_OUTPUT(PORT_OUTPUT_0,PIN_OUTPUT_0);	GPIO_WRITE(PORT_OUTPUT_0,PIN_OUTPUT_0,!DEFAULT_STATE);		break;
			case 1:	GPIO_SET_OUTPUT(PORT_OUTPUT_1,PIN_OUTPUT_1);	GPIO_WRITE(PORT_OUTPUT_1,PIN_OUTPUT_1,!DEFAULT_STATE);		break;
			case 2:	GPIO_SET_OUTPUT(PORT_OUTPUT_2,PIN_OUTPUT_2);	GPIO_WRITE(PORT_OUTPUT_2,PIN_OUTPUT_2,!DEFAULT_STATE);		break;
			case 3:	GPIO_SET_OUTPUT(PORT_OUTPUT_3,PIN_OUTPUT_3);	GPIO_WRITE(PORT_OUTPUT_3,PIN_OUTPUT_3,!DEFAULT_STATE);		break;
